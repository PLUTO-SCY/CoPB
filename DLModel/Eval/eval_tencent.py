...
def getId(xy):
    y_min, x_min = 8476380, -6530798
    y_max, x_max = 8523957, -6501798
...
class IndividualEval(object):
    ...
    def get_individual_jsds(self, t1, t2):
        ...
        f1_dist, _ = EvalUtils.arr_to_distribution(f1, 0, 1, 50)  # 原来是500桶
        f2_dist, _ = EvalUtils.arr_to_distribution(f2, 0, 1, 50)
...
# 北京的参考经纬度（单位：度）
lat0 = 39.94222187   # 参考纬度
lon0 = 116.37886747  # 参考经度
...
if __name__ == "__main__":    
    ...
    # print('numpy_array.shape: ', gen_data.shape)  # (20000, 144, 2)
    # # 衡量数据分布是否符合要求
    # print(np.mean(gen_data))  # 均值都到不了0啊。
