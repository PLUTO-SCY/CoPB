...
The dataset generated by CoPB contains a total of **200,000** user trajectories, comprising **790,949** trajectory points in total. It is designed to support both behavioral analysis and spatial-temporal pattern mining, enabling researchers to explore user movement dynamics, mobility patterns, and contextual decision-making processes in real-world scenarios. Each trajectory is a sequence of user activities, annotated with intent, timestamps, place information, and geographic coordinates.
